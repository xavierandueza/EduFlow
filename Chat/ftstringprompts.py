...
#initial user prompt
answer_question_human_template: str = f"Please provide a concise answer to this question, considering the student's academic level: {question}"
...
#initial user prompt    
check_generated_answer_hallucination_human_template: str = f"""Evaluate the following AI-generated answer. Provide feedback on the answer's accuracy and appropriateness for the specified academic level.
...
#initial user prompt
mark_student_answer_human_template: str = f"""Score the student's response and identify any errors or misconceptions, formatted as a JSON object. Focus on the accuracy and understanding of the key idea and relevant theory, considering the student's academic level:
...
#initial user prompt
provide_feedback_correct_human_template: str = f""" Provide feedback on the student's answer in the format described.
...
#initial user prompt
provide_feedback_try_again_human_template: str = f""" Provide feedback on the student's answer in the format described.
...
provide_feedback_incorrect_system_template: str = f"""
...
#initial user prompt
provide_feedback_incorrect_human_template: str = f""" Provide feedback on the student's answer in the format described.
...
#initial user prompt
discuss_theory_human_template: str = f""" Discuss the theory the student wants to go over.
...
#initial user prompt
clarify_question_human_template: str = f""" Provide clarification to the student without directly revealing the answer to the question the student asked.
