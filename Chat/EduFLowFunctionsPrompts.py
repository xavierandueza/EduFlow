...
def get_function_parameters(func):
    """
    Takes a function and returns its parameter names in a list.
    
    Args:
    func (function): The function to inspect.

    Returns:
    list: A list of parameter names for the given function.
    """
...
def generate_question(key_idea,
    ...
    return system_prompt, initial_user_prompt
