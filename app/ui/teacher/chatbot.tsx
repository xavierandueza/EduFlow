    ...
    <section className="chatbot-section flex flex-col origin:w-[800px] w-full origin:h-[735px] h-full rounded-md p-2 md:p-6">
      <div className="chatbot-header pb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {includedSkills.length > 0
                ? `Skills Included in Lesson Plan: ${includedSkills
        ...
        <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">
          After selecting the skills you want to teach in this lesson, ask to
          generate the lesson plan, and from there feel free to ask any follow
          up questions.
        </p>
      </div>
