...
const Configure = ({
  ...
  const skillOptions = [
    ...
    {
      label: "Life's Essential Conditions",
      value: "Life's Essential Conditions",
    },
  ...
  const emailOptions = [
    {
      label: "xand0001@student.monash.edu",
      value: "xand0001@student.monash.edu",
    },
    {
      label: "sben0007@student.monash.edu",
      value: "sben0007@student.monash.edu",
    },
  ];
