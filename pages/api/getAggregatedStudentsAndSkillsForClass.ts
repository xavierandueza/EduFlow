...
import { getAggregatedStudentsAndSkillsForClass } from '../../app/utils/databaseFunctionsFirestore';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const result = await getAggregatedStudentsAndSkillsForClass(schoolClassId);
